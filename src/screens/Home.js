...
export default class Home extends Component {
    ...
    renderSpeakerModal = () => {
        return (
            <Modal
                isVisible={this.state.isSpeakerModalVisible}
                backdropColor={colors.black}
                backdropOpacity={1}
                animationInTiming={250}
                animationIn="fadeInUp"
                ...
                backdropTransitionOutTiming={300}
                avoidKeyboard={true}
                onBackButtonPress={() => this.toggleSpeakerModal()}
                style={modalStyle}
            >
                <ModalContent>
                    <ModalHeader onBackButtonPress={() => this.toggleSpeakerModal()}>Speakers</ModalHeader>
                    <SpeakerModal/>
                </ModalContent>
            </Modal>
        );
